        ...
        public async Task<UserModel> GetUserByName(string userName){
            ...
            try{
               ...
               return foundUser;
                ...
                Console.WriteLine("Error!! called GetUserByName(string userName) . Error message: ");
            ...
            if (ModelState.IsValid){
                var checkUser =
                    await context.Users.FirstOrDefaultAsync(x =>
                        x.UserName == registerModel.Username); //Checks if user already exists in DB
                if (checkUser != null){
