...
namespace Test
{
    public class TestUserChatGroupNotEncrypt
    {
        [Test]
        public async Task TestSendingMessageGroupChatNotEncrypt()
        {
            ...
            try
            {
                ...
                //fill i dont want the chat to be encrypted
                ...
                await Page.GotoAsync("https://localhost:7280/New_chat?txt=calin&txt=felix");
                ...
                Assert.Multiple(() =>
                {
                    ...
                    Assert.That(urlAfterClick, Is.EqualTo("https://localhost:7280/New_chat?txt=calin&txt=felix"));
                });
